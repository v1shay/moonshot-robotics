...
const desktopLibraryAssets: LibraryAsset[] = [
  ["basecone.STL", "Robotic Arm"],
  ["TicBase.STL", "Robotic Arm"],
  ["TicBaseCover.STL", "Robotic Arm"],
  ["shoulderplate.STL", "Robotic Arm"],
  ["shouldershell.STL", "Robotic Arm"],
  ["shouldercap.STL", "Robotic Arm"],
  ["UpperArm.STL", "Robotic Arm"],
  ["UpperArm_short.STL", "Robotic Arm"],
  ["elbowshell.STL", "Robotic Arm"],
  ["elbowcap.STL", "Robotic Arm"],
  ["Forearm.STL", "Robotic Arm"],
  ["wristshell.STL", "Robotic Arm"],
  ["wristcap.STL", "Robotic Arm"],
  ["arm.STEP", "Robotic Arm"],
